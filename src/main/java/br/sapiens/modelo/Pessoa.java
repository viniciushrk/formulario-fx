...
public class Pessoa {
    ...
    public Pessoa(String nome, String sobreNome, String email, CursosEnum curso, ProfissaoEnum profissao, boolean bolsa) throws MeuException {
        this.nome = nome;
        if(nome.isEmpty())
    ...
    public String toString() {
        return nome+" "+sobreNome+" | "+email+" | "+profissao+" | "+curso+" | "+bolsa+" | ";
    }
